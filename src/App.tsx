...
import { Menu, X, ArrowUpRight, Mail, Globe, MessageSquare } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div className="bg-[#010828] text-[#EFF4FF] min-h-screen font-mono antialiased relative selection:bg-[#6FFF00] selection:text-[#010828]">
      ...
      {/* ========================================== */}
      {/* NAVBAR MOBILE-PERFECT */}
      {/* ========================================== */}
      <header className="fixed top-3 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-[1200px]">
        <div className="bg-[#010828]/70 backdrop-blur-md border border-white/10 rounded-2xl px-5 py-3.5 flex items-center justify-between">
          <span className="font-sans font-black tracking-wider text-sm">ORBIS.NFT</span>
        ...
        {isOpen && (
          <div className="bg-[#010828]/95 backdrop-blur-lg border border-white/10 rounded-2xl p-4 mt-2 flex flex-col gap-3">
            <a href="#inicio" onClick={() => setIsOpen(false)} className="text-sm font-bold py-2 border-b border-white/5">INÍCIO</a>
            <a href="#sobre" onClick={() => setIsOpen(false)} className="text-sm font-bold py-2 border-b border-white/5">SOBRE</a>
            <a href="#galeria" onClick={() => setIsOpen(false)} className="text-sm font-bold py-2 border-b border-white/5">GALERIA</a>
            <a href="#contato" onClick={() => setIsOpen(false)} className="text-sm font-bold py-2">CONTATO</a>
          </div>
        )}
      </header>

      {/* ========================================== */}
      {/* SEÇÃO 1: HERO (VÍDEO DE FUNDO + CARD INFERIOR) */}
      {/* ========================================== */}
      <section id="inicio" className="relative h-screen w-full flex flex-col justify-end overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#010828]/20 via-[#010828]/40 to-[#010828] z-10" />

        {/* Conteúdo empurrado para baixo de forma limpa */}
        <div className="relative z-20 p-5 pb-12 w-full max-w-[600px] mx-auto space-y-4">
          ...
          <h1 className="font-sans font-black text-3xl sm:text-4xl uppercase tracking-tighter leading-none text-white">
          ...
          <div className="pt-2 flex gap-3">
            <a href="#galeria" className="flex-1 text-center font-sans font-black text-xs bg-[#6FFF00] text-[#010828] py-3.5 rounded-xl tracking-wider">
              VER GALERIA
            </a>
            <a href="#sobre" className="flex-1 text-center font-sans font-bold text-xs bg-white/5 border border-white/10 text-white py-3.5 rounded-xl tracking-wider hover:bg-white/10 transition-colors">
              CONCEITO
            </a>
          </div>
        </div>
      ...
      {/* ========================================== */}
      {/* SEÇÃO 2: SOBRE (BLOCO INDEPENDENTE COM RESPIRO) */}
      {/* ========================================== */}
      <section id="sobre" className="w-full bg-[#010828] px-5 py-24 relative border-t border-white/5">
        <div className="max-w-[600px] mx-auto space-y-6">
          ...
          <p className="text-sm text-[#EFF4FF] border-l-2 border-[#6FFF00] pl-4 py-1 leading-relaxed">
            Um objeto digital fixado além do tempo e do espaço. Uma exploração estética aplicada à engenharia de contratos digitais.
          </p>

          <div className="space-y-4 pt-4 text-xs text-[#EFF4FF]/60 leading-relaxed border-t border-white/5">
            <p>• Dentro do horizonte de eventos nenhuma estrutura permanece idêntica. A matriz digital reorganiza a forma.</p>
            <p>• Produção coordenada sob regras específicas de engenharia de software com alta fidelidade visual.</p>
          </div>
        </div>
      </section>

      {/* ========================================== */}
      {/* SEÇÃO 3: GALERIA / LISTA VERTICAL LIMPA */}
      {/* ========================================== */}
      <section id="galeria" className="w-full bg-[#010828] px-5 py-12 border-t border-white/5">
      ...
      {/* ========================================== */}
      {/* SEÇÃO 4: CTA FINAL E RODAPÉ COMPLETAMENTE SEPARADOS */}
      {/* ========================================== */}
      <section id="contato" className="w-full bg-[#010828] border-t border-white/5">
        <div className="relative w-full min-h-[60vh] flex flex-col justify-center px-5 py-20">
          ...
          <div className="relative z-20 max-w-[600px] mx-auto w-full space-y-6">
            ...
            <h2 className="font-sans font-black text-3xl sm:text-4xl text-white leading-tight uppercase">
              JUNTE-SE A NÓS.<br />REVELE O OCULTO.<br />SIGA O SINAL.
            </h2>
            
            <div className="flex flex-col gap-2 pt-2">
              <a href="#" className="w-full bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl p-4 flex items-center justify-between text-xs tracking-wider transition-colors">
        ...
        {/* Rodapé isolado sem chance de colisão de texto */}
        <div className="w-full border-t border-white/5 py-8 bg-[#000518] px-5">
          <div className="max-w-[600px] mx-auto flex flex-col gap-3 text-[10px] text-[#EFF4FF]/40 tracking-wider">
            ...
            <div className="flex gap-4 font-bold">
              <a href="#" className="hover:text-[#6FFF00] transition-colors">TERMOS</a>
              <a href="#" className="hover:text-[#6FFF00] transition-colors">PRIVACIDADE</a>
            </div>
          </div>
        </div>
      </section>
